...
from ixogenlib.keys import Signature, Key
...
class Stack(list):
    ...
    For documentation of the op-methods you could check https://en.ixogen.it/wiki/Script
    """
...
def encode_num(num):
    """
    Encode number as byte used in Script language. Ixogen specific little endian format with sign for negative
    integers.
