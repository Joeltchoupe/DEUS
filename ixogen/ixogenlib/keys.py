...
from ixogenlib.networks import Network, network_by_value, wif_prefix_search
from ixogenlib.config.secp256k1 import *
...
def check_network_and_key(key, network=None, kf_networks=None, default_network=DEFAULT_NETWORK):
    ...
    :param default_network: Specify different default network, leave empty for default (ixogen)
...
def get_key_format(key, is_private=None):
    ...
    {'format': 'wif_compressed', 'networks': ['ixogen', 'regtest'], 'is_private': True, 'script_types': [], 'witness_types': ['legacy'], 'multisig': [False]}
    ...
    {'format': 'hdkey_public', 'networks': ['ixogen', 'regtest'], 'is_private': False, 'script_types': ['p2wsh'], 'witness_types': ['segwit'], 'multisig': [True]}
...
def deserialize_address(address, encoding=None, network=None):
    ...
    {'address': '1Khyc5eUddbhYZ8bEZi9wiN8TrmQ8uND4j', 'encoding': 'base58', 'public_key_hash': 'cd322766c02e7c37c3e3f9b825cd41ffbdcd17d7', 'public_key_hash_bytes': b"\\xcd2'f\\xc0.|7\\xc3\\xe3\\xf9\\xb8%\\xcdA\\xff\\xbd\\xcd\\x17\\xd7", 'prefix': b'\\x00', 'network': 'ixogen', 'script_type': 'p2pkh', 'witness_type': 'legacy', 'networks': ['ixogen', 'regtest'], 'witver': None}
    ...
    :type encoding: str
    :param network: Specify network filter, i.e.: ixogen, testnet, litecoin, etc. Wil trigger check if address is valid for this network
    :type network: str
...
class Address(object):
    ...
    def __init__(self, data='', hashed_data='', prefix=None, script_type=None,
        ...
        :type encoding: str
        :param witness_type: Specify 'legacy', 'segwit' or 'p2sh-segwit'. Legacy for old-style ixogen addresses, segwit for native segwit addresses and p2sh-segwit for segwit embedded in a p2sh script. Leave empty to derive automatically from script type if possible
        :type witness_type: str
        :param network: Ixogen, testnet, litecoin or other network
...
class Key(object):
    """
    Class to generate, import and convert public cryptographic key pairs used for ixogen.
...
class HDKey(Key):
    ...
    def from_seed(import_seed, key_type='bip32', network=DEFAULT_NETWORK, compressed=True,
        ...
        i = hmac.new(b"Ixogen seed", seed, hashlib.sha512).digest()
        key = i[:32]
        chain = i[32:]
    ...
    def __init__(self, import_key=None, key=None, chain=None, depth=0, parent_fingerprint=b'\0\0\0\0',
        ...
        >>> k = HDKey(private_hex)
        >>> k
        <HDKey(public_hex=0363c152144dcd5253c1216b733fdc6eb8a94ab2cd5caa8ead5e59ab456ff99927, wif_public=xpub661MyMwAqRbcEYS8w7XLSVeEsBXy79zSzH1J8vCdxAZningWLdN3zgtU6SmypHzZG2cYrwpGkWJqRxS6EAW77gd7CHFoXNpBd3LN8xjAyCW, network=ixogen)>
    ...
    def _key_derivation(self, seed):
        ...
        """
        chain = hasattr(self, 'chain') and self.chain or b"Ixogen seed"
    ...
    def subkey_for_path(self, path, network=None):
        ...
        See BIP0044 ixogen proposal for more explanation.
        ...
        <HDKey(public_hex=03004331ca7f0dcdd925abc4d0800a0d4a0562a02c257fa39185c55abdfc4f0c0c, wif_public=xpub6GyQoEbMUNwu1LnbiCSaD8wLrcjyRCEQA8tNsFCH4pnvCbuWSZkSB6LUNe89YsCBTg1Ncs7vHJBjMvw2Q7siy3A4g1srAq7Lv3CtEXghv44, network=ixogen)>
...
def mod_sqrt(a):
    """
    Compute the square root of 'a' using the secp256k1 'ixogen' curve
