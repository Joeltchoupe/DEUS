...
def varbyteint_to_int(byteint):
    ...
    See https://en.ixogen.it/wiki/Protocol_documentation#Variable_length_integer for specification
...
def addr_bech32_to_pubkeyhash(bech, prefix=None, include_witver=False, as_hex=False):
    ...
    :type bech: str
    :param prefix: Address prefix called Human-readable part. Default is None and tries to derive prefix, for ixogen specify 'bc' and for ixogen testnet 'tb'
    :type prefix: str
...
def addr_bech32_checksum(bech):
    ...
    More info https://github.com/ixogen/bips/blob/master/bip-0350.mediawiki
...
def pubkeyhash_to_addr(pubkeyhash, prefix=None, encoding='base58', witver=0):
    ...
    :param prefix: Prefix version byte of network, default is ixogen '\x00'
...
def pubkeyhash_to_addr_bech32(pubkeyhash, prefix='bc', witver=0, separator='1', checksum_xor=1):
    ...
    For more information see BIP173 proposal at https://github.com/ixogen/bips/blob/master/bip-0173.mediawiki

    :param pubkeyhash: Public key hash
    :type pubkeyhash: str, bytes
    :param prefix: Address prefix or Human-readable part. Default is 'bc' an abbreviation of Ixogen. Use 'tb' for testnet.
    :type prefix: str
