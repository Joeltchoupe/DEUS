...
from ixogenlib.transactions import Transaction
...
class Block:
    ...
    def __init__(self, block_hash, version, prev_block, merkle_root, time, bits, transactions=None,
        ...
        >>> b = Block('0000000000000000000154ba9d02ddd6cee0d71d1ea232753e02c9ac6affd709', version=0x20000000, prev_block='0000000000000000000f9578cda278ae7a2002e50d8e6079d11e2ea1f672b483', merkle_root='20e86f03c24c53c12014264d0e405e014e15a02ad02c174f017ee040750f8d9d', time=1592847636, bits=387044594)
        >>> b
    ...
    def parse(cls, raw, block_hash=None, height=None, parse_transactions=False, limit=0, network=DEFAULT_NETWORK):
        ...
        >>> from ixogenlib.datas import Genesis
        >>> srv = Genesis()
        >>> b = srv.getblock(0)
        >>> b.block_hash.hex()
    ...
    def from_raw(cls, raw, block_hash=None, height=None, parse_transactions=False, limit=0, network=DEFAULT_NETWORK):  # pragma: no cover
        ...
        :return Block:
        """
        block_hash_calc = double_sha256(raw[:76])[::-1]
        if not block_hash:
            block_hash = block_hash_calc
        elif block_hash != block_hash_calc:
            raise ValueError("Provided block hash does not correspond to calculated block hash %s" %
        ...
        time = raw[68:72][::-1]
        bits = raw[72:76][::-1]
        tx_count, size = varbyteint_to_int(raw[76:89])
        txs_data = BytesIO(raw[76+size:])
    ...
    def serialize(self):
        ...
        A block consists of a 76 bytes header:
        * version - 4 bytes
    ...
    def version_bips(self):
        ...
        The block version shows which software the miner used to create the block. Changes to the ixogen
        protocol are described in Ixogen Improvement Proposals (BIPs) and a miner shows which BIPs it supports
