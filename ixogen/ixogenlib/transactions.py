...
from ixogenlib.config.opcodes import *
from ixogenlib.keys import HDKey, Key, deserialize_address, Address, sign, verify, Signature
...
def transaction_deserialize(rawtx, network=DEFAULT_NETWORK, check_size=True):  # pragma: no cover
    ...
    :param network: Network code, i.e. 'ixogen', 'testnet', 'litecoin', etc. Leave emtpy for default network
...
class Transaction(object):
    ...
    def add_output(self, value, address='', public_hash=b'', public_key=b'', lock_script=b'', spent=False,
        ...
        :param value: Value of output in the smallest denominator of currency, for example satoshi's for ixogens
        :type value: int
